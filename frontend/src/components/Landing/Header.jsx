...
export default function Header() {
  ...
  // Button base styles
  const buttonBase = "rounded-md font-medium transition-all duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#080808]";
          ...
          <div className="md:hidden absolute top-full left-0 right-0 bg-[#080808] p-4 border-t border-white/10 shadow-xl">
            ...
            <div className="mt-6 pt-4 border-t border-white/10 flex flex-col gap-4">
              <Link to="/signin" onClick={() => setMobileMenuOpen(false)}>
                <button className={buttonMobileOutline}>
                  Login
                </button>
              </Link>
              <Link to="/signup" onClick={() => setMobileMenuOpen(false)}>
                <button className={buttonMobilePrimary}>
                  Sign Up
                </button>
              </Link>
            </div>
