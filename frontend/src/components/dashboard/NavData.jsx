...
const DashboardCard = ({ title, count, thisMonthCount, logo, bg }) => {
  return (
    <div className={`${bg} cursor-pointer text-white rounded-2xl flex items-center justify-between rounded-lg p-6 shadow-md`}>
     <div>
...
function NavData() {
  ...
  return <div className="mt-24 px-8">
     <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
      ...
      <DashboardCard title="Total Employees" count="0" thisMonthCount="0" logo={<BsPersonWorkspace />} bg="bg-[#A1A3D9]" />
